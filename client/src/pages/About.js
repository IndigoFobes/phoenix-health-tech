...
export default function About() {
  ...
  return (
    <div className="bg-fixed about-bg relative">
      <ScrollContainer>
        <div className="shadow-inner pb-8 bg-gray-200 opacity-80 w-full h-[270px] sm:h-[300px] md:h-[330px] lg:h-[290px]"></div>
        <ScrollPage>
          <Animator animation={FadeUp}>
            <div className="col-start-2 col-end-6 mb-5 mt-10">
              <h1 className=" rounded-sm meet-team text-center font-semibold dm-sans-bold text-white">
                Meet Our Team
              </h1>
            </div>
          </Animator>
              ...
              <div className="sm:col-start-3 sm:col-end-8 flex sm:ml-10 items-center">
                <div className="flex flex-col gap-2 text-justify">
                  ...
                  <p className="text-xs sm:text-sm md:text-base">
                    ...
                    efficitur dignissim pulvinar. Sed vulputate posuere
                    ...
                    egestas leo. Ut quis neque elit. In congue elit rhoncus
                    justo viverra congue.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col place-items-center my-5 md:my-10 sm:grid sm:grid-cols-7">
              ...
              <div className="col-start-3 col-end-8 flex sm:ml-10 items-center">
                <div className="flex flex-col gap-2 text-justify">
                  ...
                  <p className="text-xs sm:text-sm md:text-base">
                    Text about Robert D’Agostino, Legal Advisor. Lorem ipsum
                    dolor sit amet, consectetur adipiscing elit. Vestibulum
                    laoreet a nisl sit amet facilisis. Vestibulum id tellus
                    felis. Vestibulum efficitur dignissim pulvinar. Sed
                    vulputate posuere ultrices. Integer blandit dui ut laoreet
                    bibendum. Maecenas tristique, diam a mollis euismod, nunc
                    erat ultricies orci, vel auctor ex nulla in erat. Ut
                    imperdiet, purus a porttitor dignissim, nisi neque ultrices
                    eros, a commodo lectus lectus egestas leo. Ut quis neque
                    elit. In congue elit rhoncus justo viverra congue.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col place-items-center my-5 md:my-10 sm:grid sm:grid-cols-7">
              ...
              <div className="col-start-3 col-end-8 flex sm:ml-10 items-center">
                <div className="flex flex-col gap-2 text-justify">
                  ...
                  <p className="text-xs sm:text-sm md:text-base">
                    Text about Brian Douglas, Corporate Counsel. Lorem ipsum
                    dolor sit amet, consectetur adipiscing elit. Vestibulum
                    laoreet a nisl sit amet facilisis. Vestibulum id tellus
                    felis. Vestibulum efficitur dignissim pulvinar. Sed
                    vulputate posuere ultrices. Integer blandit dui ut laoreet
              ...
              <div className="col-start-3 col-end-8 flex sm:ml-10 items-center">
                <div className="flex flex-col gap-2 text-justify">
                  ...
                  <p className="text-xs sm:text-sm md:text-base">
                    ...
                    Vestibulum laoreet a nisl sit amet facilisis. Vestibulum id
                    tellus felis. Vestibulum efficitur dignissim pulvinar. Sed
                    vulputate posuere ultrices. Integer blandit dui ut laoreet
                    bibendum. Maecenas tristique, diam a mollis euismod, nunc
                    erat ultricies orci, vel auctor ex nulla in erat. Ut
                    imperdiet, purus a porttitor dignissim, nisi neque ultrices
